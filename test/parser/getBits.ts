...
import {setBits} from '../../src/parser/parser'

describe('setBits', () => {
    it('check bit status for spec 1-5/1', () => {
        const spec = setBits(1, 5, 1);
